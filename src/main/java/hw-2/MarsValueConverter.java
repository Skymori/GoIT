class MarsValueConverter{
    ...
    public static void main(String[] args) {
        ...
        System.out.println("changeMoneyAmount(100f, 40.5f)= " + marsValueConverter.changeMoneyAmount(100f, 40.5f));
        System.out.println("calculateMoneySum(50, 40)= " + marsValueConverter.calculateMoneySum(50, 40));
        System.out.println("halfOfMoney(1000.9999)= " + marsValueConverter.halfOfMoney(1000.9999));
    }
}